...
public class PTra10_01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(us.userId = 1234);
		System.out.println(us.userNm = "山田ゆかり");
		System.out.println(us.mail = "yamada@yahoo.co.jp");
		System.out.println(us.password = "qassmorb");
